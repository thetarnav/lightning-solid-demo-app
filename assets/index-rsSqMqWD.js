const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-CJGmg5U2.js","assets/index-DNCDCW9C.js","assets/Infinite-CLzFnT3W.js","assets/Components-DotDMW1l.js","assets/Button-BZRHu0q4.js","assets/Login-KpUrZgQ_.js"])))=>i.map(i=>d[i]);
    ...
    for (const key2 in props) {
      if (key2 !== "shaderProps") {
        ...
        for (const key3 in props.shaderProps) {
          let start = node.shader.props[key3];
...
class CoreNode extends EventEmitter {
  ...
  update(delta, parentClippingRect) {
    ...
    if (this.updateType & UpdateType.Global) {
      ...
      this.setUpdateType(UpdateType.RenderState | UpdateType.Children | UpdateType.RecalcUniforms);
    ...
    if (((_a2 = this.shader) == null ? void 0 : _a2.update) !== void 0 && (this.updateType & UpdateType.Local || this.updateType & UpdateType.RecalcUniforms)) {
      this.shader.update();
    }
      ...
      Object.defineProperty(definedProps, key2, {
        ...
        set: (value) => {
          if (isAdvancedProp === true && propConfig.resolve !== void 0) {
            this.resolvedProps[key2] = propConfig.resolve(value, this.resolvedProps);
...
class WebGlShaderProgram {
  ...
  bindRenderOp(renderOp) {
    ...
    if (renderOp.sdfShaderProps !== void 0) {
      (_a2 = renderOp.shader.shaderType.onSdfBind) == null ? void 0 : _a2.call(this.glw, renderOp.sdfShaderProps);
      return;
    }
...
class WebGlRenderer extends CoreRenderer {
  ...
  reuseRenderOp(params2) {
    ...
    if (!this.curRenderOp.shader.program.reuseRenderOp(params2, this.curRenderOp.quad)) {
      return false;
    }
    return true;
  }
...
function getNodeStyles(node) {
  ...
  if (node instanceof DOMText) {
    ...
    if (node.fontWeight !== "normal")
      style += "font-weight: ".concat(node.fontWeight, ";");
    if (node.fontStretch !== "normal")
      style += "font-stretch: ".concat(node.fontStretch, ";");
    ...
    if (node.colorBottom !== node.colorTop) {
      bgImg.push(
        "linear-gradient(".concat(colorToRgba(node.colorTop), ", ").concat(colorToRgba(node.colorBottom), ")")
      );
    }
    if (node.colorLeft !== node.colorRight) {
      bgImg.push(
        "linear-gradient(to right, ".concat(colorToRgba(node.colorLeft), ", ").concat(colorToRgba(node.colorRight), ")")
      );
    }
...
function updateRootPosition() {
  ...
  let height = Math.ceil(
    (_b = settings.appHeight) != null ? _b : 1080 / ((_a2 = settings.deviceLogicalPixelRatio) != null ? _a2 : 1)
  );
  let width = Math.ceil(
    (_d = settings.appWidth) != null ? _d : 1920 / ((_c = settings.deviceLogicalPixelRatio) != null ? _c : 1)
  );
...
const Grid = lazy(() => __vitePreload(() => import("./Grid-CfDT-1IZ.js"), true ? [] : void 0));
const Loops = lazy(() => __vitePreload(() => import("./Loops-CJGmg5U2.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Infinite = lazy(() => __vitePreload(() => import("./Infinite-CLzFnT3W.js"), true ? __vite__mapDeps([2,1]) : void 0));
const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-Ctq8pRkZ.js"), true ? [] : void 0));
const Portal = lazy(() => __vitePreload(() => import("./Portal-9ozOiXRY.js"), true ? [] : void 0));
const TextPage = lazy(() => __vitePreload(() => import("./Text-BKKUYzfx.js"), true ? [] : void 0));
const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-BoRBZTIF.js"), true ? [] : void 0));
const CreatePage = lazy(() => __vitePreload(() => import("./Create-C_FV9dMV.js"), true ? [] : void 0));
const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BGHKoJ90.js"), true ? [] : void 0));
const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CpyoOLWX.js"), true ? [] : void 0));
const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-D8GZE4Vw.js"), true ? [] : void 0));
const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BfwXREPo.js"), true ? [] : void 0));
const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-BvsWN9Y5.js"), true ? [] : void 0));
const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-Clsyfxzm.js"), true ? [] : void 0));
const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DotDMW1l.js"), true ? __vite__mapDeps([3,4]) : void 0));
const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-B3MX7IeG.js"), true ? [] : void 0));
const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-D9xeCADN.js"), true ? [] : void 0));
const FlexPage = lazy(() => __vitePreload(() => import("./Flex-C_Aqxcgz.js"), true ? [] : void 0));
const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BpyBrmLG.js"), true ? [] : void 0));
const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-B8J5FDMJ.js"), true ? [] : void 0));
const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Fz9pmPlO.js"), true ? [] : void 0));
const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DMX8tAHc.js"), true ? [] : void 0));
const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Dysde6_K.js"), true ? [] : void 0));
const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Ck1NKmAt.js"), true ? [] : void 0));
const Entity = lazy(() => __vitePreload(() => import("./Entity-B7qmmCbH.js"), true ? [] : void 0));
const People = lazy(() => __vitePreload(() => import("./People-BrxsJdeD.js"), true ? [] : void 0));
const LoginPage = lazy(() => __vitePreload(() => import("./Login-KpUrZgQ_.js"), true ? __vite__mapDeps([5,4]) : void 0));
const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-vjlhU-Ma.js"), true ? [] : void 0));
