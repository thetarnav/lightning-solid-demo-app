...
(function () {
  ...
  System.register(['./index-legacy-C1phaOSK.js', './index-legacy-DKOPW2Af.js'], function (exports, module) {
    'use strict';
      ...
      execute: function execute() {
        var Loops = exports("default", props => {
          ...
          var currentIndex = 0,
            solidLogo;
          createEffect(() => {
            var all = [{}, ...props.data.rows.map(row => row.items()).flat()];
            setAllItems(all);
                  ...
                  return createComponent(View, {
                    ...
                    get children() {
                      return createComponent(List, {
                        ...
                        children: (item, index) => {
                          var isEdgeItem = () => index() === 0 || index() === displayedItems().length - 1;
...
//# sourceMappingURL=Infinite-legacy-BfRerdEW.js.map
