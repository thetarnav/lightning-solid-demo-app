...
(function () {
  ...
  `
        ...
        var Grid = lazy(() => __vitePreload(() => module.import('./Grid-legacy-DdtlHE5S.js'), false ? __VITE_PRELOAD__ : undefined));
        var Loops = lazy(() => __vitePreload(() => module.import('./Loops-legacy-Cqub08nJ.js'), false ? __VITE_PRELOAD__ : undefined));
        var Infinite = lazy(() => __vitePreload(() => module.import('./Infinite-legacy-BKeXH9dF.js'), false ? __VITE_PRELOAD__ : undefined));
        var TMDBGrid = lazy(() => __vitePreload(() => module.import('./TMDBGrid-legacy-DFNmUOIS.js'), false ? __VITE_PRELOAD__ : undefined));
        var Portal = lazy(() => __vitePreload(() => module.import('./Portal-legacy-AnDH5ZT5.js'), false ? __VITE_PRELOAD__ : undefined));
        var TextPage = lazy(() => __vitePreload(() => module.import('./Text-legacy-CDYIV_gB.js'), false ? __VITE_PRELOAD__ : undefined));
        var TextPosterPage = lazy(() => __vitePreload(() => module.import('./TextPoster-legacy-DVy7KrUL.js'), false ? __VITE_PRELOAD__ : undefined));
        var CreatePage = lazy(() => __vitePreload(() => module.import('./Create-legacy-BXrS0XZ0.js'), false ? __VITE_PRELOAD__ : undefined));
        var ViewportPage = lazy(() => __vitePreload(() => module.import('./Viewport-legacy-DdAZm8JE.js'), false ? __VITE_PRELOAD__ : undefined));
        var PositioningPage = lazy(() => __vitePreload(() => module.import('./Positioning-legacy-ghHcTDhc.js'), false ? __VITE_PRELOAD__ : undefined));
        var LayoutPage = lazy(() => __vitePreload(() => module.import('./Layout-legacy-B3kuXOrz.js'), false ? __VITE_PRELOAD__ : undefined));
        var FocusBasicsPage = lazy(() => __vitePreload(() => module.import('./FocusBasics-legacy-By2nSlAy.js'), false ? __VITE_PRELOAD__ : undefined));
        var KeyHandlingPage = lazy(() => __vitePreload(() => module.import('./KeyHandling-legacy-Bi3PRyRk.js'), false ? __VITE_PRELOAD__ : undefined));
        var TransitionsPage = lazy(() => __vitePreload(() => module.import('./Transitions-legacy-CwbyRhoj.js'), false ? __VITE_PRELOAD__ : undefined));
        var ComponentsPage = lazy(() => __vitePreload(() => module.import('./Components-legacy-CQoGgsd9.js'), false ? __VITE_PRELOAD__ : undefined));
        var FocusHandlingPage = lazy(() => __vitePreload(() => module.import('./FocusHandling-legacy-CFP0_TIJ.js'), false ? __VITE_PRELOAD__ : undefined));
        var GradientsPage = lazy(() => __vitePreload(() => module.import('./Gradients-legacy-ohNeffGF.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexPage = lazy(() => __vitePreload(() => module.import('./Flex-legacy-Dp8MYI5x.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexGrowPage = lazy(() => __vitePreload(() => module.import('./FlexGrow-legacy-3tjHsUZh.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexSizePage = lazy(() => __vitePreload(() => module.import('./FlexSize-legacy-TmLZ6VJB.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexColumnSizePage = lazy(() => __vitePreload(() => module.import('./FlexColumnSize-legacy-DN4tNkSK.js'), false ? __VITE_PRELOAD__ : undefined));
        var FlexColumnPage = lazy(() => __vitePreload(() => module.import('./FlexColumn-legacy-DGqHv8Od.js'), false ? __VITE_PRELOAD__ : undefined));
        var ButtonsMaterialPage = lazy(() => __vitePreload(() => module.import('./ButtonsMaterial-legacy-Cn--F4om.js'), false ? __VITE_PRELOAD__ : undefined));
        var SuperFlexPage = lazy(() => __vitePreload(() => module.import('./SuperFlex-legacy-wkovFuy_.js'), false ? __VITE_PRELOAD__ : undefined));
        var Entity = lazy(() => __vitePreload(() => module.import('./Entity-legacy-DM2VdO-S.js'), false ? __VITE_PRELOAD__ : undefined));
        var People = lazy(() => __vitePreload(() => module.import('./People-legacy-CvCeegP8.js'), false ? __VITE_PRELOAD__ : undefined));
        var LoginPage = lazy(() => __vitePreload(() => module.import('./Login-legacy-decw4JET.js'), false ? __VITE_PRELOAD__ : undefined));
        var FireboltPage = lazy(() => __vitePreload(() => module.import('./Firebolt-legacy-DV5mSwdE.js'), false ? __VITE_PRELOAD__ : undefined));
